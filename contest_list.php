...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <script>
    	function contest_write_chk() {
    		var p_set = document.frm_contest_write;
        ...
        function content_lengCounter() {
			document.getElementById("content_counter").innerHTML=document.getElementById("content_textarea").value.length;
        }
        ...
        function not_alert() {
			alert('공모전 글 최대 작성 수 3개를 초과하셨습니다!');
        }
    	</script>
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="culmn">
			...
			<?php include "searchContestList.php"; ?>
            ...
            <div class="container">
            	...
            	<div class="col-sm-10 col-sm-offset-1">
                    <div class="col-sm-10">
                    	<form method="post" action="contest_list.php?mode=search&kind=<?php echo $kind; ?>">
                            ...
                            <button type="submit" class="btn btn-primary" style="padding: 1.2em 1.5em;"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-sm-10 col-sm-offset-1 m-top-20">
                	<div class="col-sm-3">
                        ...
                        ?>
                        	<button type='button' class="home_btns form-control btn btn-primary" data-toggle="modal" data-target="#modal_contest_write">글쓰기</button>
                        <?php 
                        } 
                        ?>
                    </div>
                ...
                <!-- 정렬 선택 -->
                    <div class="col-sm-3">
                        <form method="post" action="contest_list.php?mode=search&kind=<?php echo $kind; ?>">
                            ...
                            <option value="contest_list.php?kind=<?php echo $kind?>&range=num">글번호</option>
                            <option value="contest_list.php?kind=<?php echo $kind?>&range=author">작성자</option>
                            <option value="contest_list.php?kind=<?php echo $kind?>&range=topic">주제</option>
                            </select>
                        </form>
                    </div>
                </div>
            
			<!-- contest목록 각 하나의 article -->
			<!--블럭 내에 보여 줄 데이터들 DB에서 가져온 값이 저장된 $row 변수에서 한 속성씩 빼냄-->
                ...
                <?php 
                    ...
                    if($item_apply_e < $timenow) {
                        if(abs($diff_date) < 10) { // 신청 마감일과 현재 날짜가 10일 이상 차이나면 아예 안나옴
                            if($diff_date < 0) {
                                ...
                                <div class='col-sm-6 m-top-10'>
                                    ...
                                    <a href='$item_topic'><span class='title'>$item_title</span></a>

                                    <span class='content'>$item_content</span>
                                ...
                                if($userid==$item_id){ //신청기간 지난 게시물의 삭제 버튼
                                    ?>
                                    <a href="contest_delete_process.php?num=<?=$item_num?>&page=<?=$page?>&kind=<?=$kind?>" style="float: right;">
                                        <button type="button" class="btn btn-primary" style="padding: 1em 1.3em; border-radius: 50%;">
                    ...
                    echo "
                        <a href='contest_view.php?num=$item_num&page=$page&kind=$kind&big=contest' style='text-decoration: none;'>
                            <div class='col-sm-6 m-top-10'>
                                ...
                                <span class='title' style='margin-top: 15px;'>$item_title</span>
...
<!-- Insert Modal -->
<div class="modal fade" id="modal_contest_write" role="dialog">
    ...
    <!-- Modal content-->
        ...
        <div class="modal-header">
            <h6 class="modal-title" style="display: inline-block;">contest - Write</h6>
        ...
        <div class="modal-body" style="padding: 50px;">
                <form name="frm_contest_write" class="form_write" method="post" action="contest_insert_process.php?num=<?php echo $num ?>&page=<?php echo $page ?>&kind=<?php echo $kind ?>&big=<?php echo $big ?>">
                    ...
                    <span id="contest_write_topic_result" class="fail"></span>
                    ...
                    <div class="textarea_counter">
                        ...
                        <span id="contest_write_title_result" class="fail"></span>
                    </div>

                    <div class="textarea_counter">
                        <label>
                            담당 파트 ex) 디자인 1, 기획 2
                        <textarea id="textarea" name="write_part" class="part" maxlength="500" onkeyup="lengCounter()"></textarea>
        ...
        <div class="modal-footer">
            <div class="col-sm-3 col-sm-offset-9">
                <button type="button" onClick="contest_write_chk()" class="form-control btn btn-primary">저장</button>
            </form>
            </div>
        </div> <!-- modal footer -->
