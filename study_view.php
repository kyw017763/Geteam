...
if($kind=="develop"){
    $view_sql = "SELECT * FROM `study_develop` WHERE num='$num' AND end_day >= curdate( )"; 
} else if($kind=="design"){
    $view_sql = "SELECT * FROM `study_design` WHERE num='$num' AND end_day >= curdate( )"; 
} else if($kind=="etc"){
    $view_sql = "SELECT * FROM `study_etc` WHERE num='$num' AND end_day >= curdate( )"; 
}
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
            ...
            <div class="row">
                ...
                <div class="main_featured m-top-100">
                    ...
                    <div class="col-sm-12 m-top-50">
                        ...
                        <?php
                        if($kind=="develop"){
                            $d_sql = "SELECT * FROM apply_study_develop WHERE num_recv = $num";
                        } else if($kind=="design"){
                            $d_sql = "SELECT * FROM apply_study_design WHERE num_recv = $num";
                        } else if($kind=="etc"){
                            $d_sql = "SELECT * FROM apply_study_etc WHERE num_recv = $num";
                        } 
                ...
                <article class="col-sm-12  m-top-50 article_container">
                    ...
                    <div class="col-sm-3 col-xs-7 articlesub_t">
                        ...
                        <?php
                        if($kind=="develop"){
                            $list_sql = mysqli_query($conn, "SELECT * FROM apply_study_develop WHERE num_recv='$item_num' AND id_apply='$userid'");
                        } else if($kind=="design"){
                            $list_sql = mysqli_query($conn, "SELECT * FROM apply_study_design WHERE num_recv='$item_num' AND id_apply='$userid'");
                        } else if($kind=="etc"){
                            $list_sql = mysqli_query($conn, "SELECT * FROM apply_study_etc WHERE num_recv='$item_num' AND id_apply='$userid'");
                        }
        ...
        <div class="modal fade" id="modal_study_apply" role="dialog">
            ...
            <!-- Modal content-->
                ...
                <div class="modal-body" style="padding: 50px;">
                        <form class="form_write" method="post" action="apply_insert_process.php?num=<?php echo $num ?>&page=<?php echo $page ?>&kind=<?php echo $kind?>&big=<?php echo $big ?>">
